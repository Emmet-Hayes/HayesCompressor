...
namespace Constants
{
    namespace Colors
    {
        ...
        constexpr uint32_t bg_AppMagenta{ 0xff220d22 };
        constexpr uint32_t bg_DarkMagenta { 0xff441a44 };
        constexpr uint32_t bg_Magenta { 0xff662b66 };
        constexpr uint32_t bg_LightMagenta{ 0xff883c88 };
        //Gradients
